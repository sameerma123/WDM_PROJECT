        ...
        <section style="margin: 5%">
            <form action="">
                <div>
                    ...
                    <input type="text" id="id" placeholder="id" class="formSpace corners" required>
                </div><br/>
                <div>
                ...
                <div class="textArea">
                    <label for="purpose" class="bold">Associations</label>
                ...
                <div>
                    <button type="Submit" class="button corners" onclick="proyectosAdd(0)">Update</button>
                </div>
            </form>
            <table>
                <tr>
